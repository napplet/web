...
Last activity: 2026-07-07 — Quick task 260706-dmu completed; NAP-DM result message types now enforce success-or-error unions and export `DmError` through the package type surface. (Prior 2026-07-06 quick tasks 260706-rm2, 260706-qdq, and 260706-eh0 kept below.)
