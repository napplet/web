...
last_activity: 2026-07-06 - Completed quick task 260706-cmn: Align NAP-COMMON profile result
progress:
  total_phases: 0
  completed_phases: 0
  total_plans: 0
...
Follow-up activity: 2026-07-06 - Quick task 260706-cmn completed; Common profile lookup now returns the NAP-defined RelayEventResult wrapper as `result?`.
