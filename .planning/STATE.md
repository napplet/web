...
- Verification: `pnpm --filter @napplet/docs build`; `git diff --check`;
  ...
  (0 tasks); `pnpm dlx aislop@0.12.0 scan --changes --base
  origin/docs/simplify-note-drafts-agent-prompt .` (98/100 from the existing
  `js-yaml` advisory).
- Commit: `991d104c` (`Put concepts before tutorials in docs sidebar`).
...
|----------|------|------|--------|-----------|
| 260710-mzr | Move Core Concepts to the top of the affected docs section | 2026-07-10 | 991d104c | [260710-mzr-move-core-concepts-to-the-top-of-the-aff](./quick/260710-mzr-move-core-concepts-to-the-top-of-the-aff/) |
