...
- `pnpm dlx aislop@0.12.0 scan --changes --base origin/docs/simplify-note-drafts-agent-prompt .` - passed with 98/100; only warning is the existing `js-yaml` advisory
