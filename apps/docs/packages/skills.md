...
| `build-napplet` | Implementation | `@napplet/shim` + `@napplet/sdk`, the Vite manifest plugin, relay / storage / identity / inc / resource / config / theme, capability gating via domain presence, the single-file artifact rule. |
