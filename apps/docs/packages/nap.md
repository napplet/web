...
notify, identity, config, resource, cvm, outbox, upload, intent, ble)
...
- **ble** — runtime-mediated BLE/GATT sessions. Napplets use shell-scoped
  session ids while the shell owns device permission, backend handles, GATT
