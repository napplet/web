...
| [`@napplet/nap`](./nap) | All 20 active domain subpaths as layered exports (barrel / types / shim / sdk per active NAP domain, plus shell/ifc compatibility). Tree-shakable. |
