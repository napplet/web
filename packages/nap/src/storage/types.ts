...
/** The NAP domain name for storage messages. */
...
/** All storage NAP message types (discriminated union on `type` field). */
export type StorageNapMessage = StorageRequestMessage | StorageResultMessage;
