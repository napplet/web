// @napplet/nap/class -- Class NAP shim (wire handler for class.assigned envelope).
//
...
//
// Per NAP-CLASS.md wire contract:
 ...
 * (Phase 139 wires @napplet/shim to route envelopes here via registerNap).
 *
 ...
 *
 * Note: the actual envelope routing (registerNap) is performed by the index.ts
 * barrel so that importing `@napplet/nap/class` is sufficient for the central
 ...
 * @example
 * ```ts
 * import { installClassShim } from '@napplet/nap/class';
