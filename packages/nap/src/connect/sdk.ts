/**
 * @napplet/nap/connect -- SDK helpers wrapping window.napplet.connect.
 *
 ...
 * not implement `nap:connect`.
 *
 * @returns boolean grant state
 *
 * @example
 * ```ts
 * import { connectGranted } from '@napplet/nap/connect';
 * if (connectGranted()) {
 ...
 * @example
 * ```ts
 * import { connectOrigins } from '@napplet/nap/connect';
