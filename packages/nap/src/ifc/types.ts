/**
 * @napplet/nap/ifc -- Inter-frame communication message types for the JSON envelope wire protocol.
 *
...
/** The NAP domain name for inter-frame communication messages. */
export const DOMAIN = 'ifc' as const;

/**
 * Base interface for all IFC NAP messages.
...
/** All IFC NAP message types (discriminated union on `type` field). */
export type IfcNapMessage = IfcTopicMessage | IfcChannelMessage;
