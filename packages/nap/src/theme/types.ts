...
/** The NAP domain name for theme messages. */
...
/**
 * Base interface for all theme NAP messages.
...
/** All theme NAP message types (discriminated union on `type` field). */
export type ThemeNapMessage = ThemeRequestMessage | ThemeResultMessage;
