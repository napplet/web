...
/**
 * Base interface for all relay NAP messages.
 ...
 * to upstream hosts before the user has rendered the event). See NAP-RELAY
...
/** All relay NAP message types (discriminated union on `type` field). */
export type RelayNapMessage = RelayOutboundMessage | RelayInboundMessage;
